...
<div class="content-wrapper h-[calc(100vh-4rem)] overflow-y-auto bg-gray-200">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-12">
                    <h3 class="m-0 content-title text-xl text-red-950 font-semibold">Data Mapel</h3>
                </div>
            </div>
        </div>
    </div>
                            ...
                            <tbody>
                                @foreach ($mapel as $d)
                                    <tr>
                                        ...
                                        <td>{{ $d->nama_mapel }}</td>
                                        <td>
                                            <form action="{{route('mapel.hapus', $d->nama_mapel)}}">
                                                <a href="{{route('mapel.ubah', $d->nama_mapel)}}">
                                                    Edit
                                                </a>
                                                <button>
                                                    Hapus
