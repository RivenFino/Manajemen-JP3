...
<div class="content-wrapper h-[calc(100vh-4rem)] overflow-y-auto bg-gray-200">
    ...
    <section class="content ">
        <div class="w-full min-h-full flex justify-center items-center px-8 flex-col">
            ...
            <form action="{{route('guru.ubah.simpan', $guru->nip)}}" method="POST"
                ...
                <div class="flex flex-col w-full justify-center items-start gap-2 py-2">
                    ...
                    <input type="text" disabled class="w-full h-12 px-4 text-xl rounded-lg"
                        value="{{old('nip', $guru->nip)}}" name="nip" required>
                    @error('nip')
                ...
                <div class="flex flex-col w-full justify-center items-start gap-2 py-2">
                    ...
                    <input type="text" class="w-full h-12 px-4 text-xl rounded-lg" value="{{old('nip', $guru->nama)}}"
                        name="nama" required>
                    @error('nama')
                        <div class="text-red-600 bg-red-100 m-2 text-center rounded-md">
                            {{ $message }}
