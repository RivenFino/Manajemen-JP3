        ...
        <div class="content-wrapper h-[calc(100vh-4rem)] overflow-y-auto bg-gray-200">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-12">
                            <h3 class="m-0 content-title text-xl text-red-950 font-semibold">Tambah Data Guru</h3>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <section class="content ">
                ...
                <div class="w-full min-h-full flex justify-center items-center px-8 flex-col">
                    ...
                    <form action="{{route('guru.tambah.simpan')}}" method="POST"
                        ...
                        <div class="flex flex-col w-full justify-center items-start gap-2 py-2">
                            <label for="" class="text-2xl font-semibold">NIP</label>
                            <input type="text" class="w-full h-12 px-4 text-xl rounded-lg" name="nip" required>
                            @error('nip')
                        ...
                        <div class="flex flex-col w-full justify-center items-start gap-2 py-2">
                            <label for="" class="text-2xl font-semibold">Nama</label>
                            <input type="text" class="w-full h-12 px-4 text-xl rounded-lg" name="nama" required>
                            @error('nama')
                                <div class="text-red-600 bg-red-100 m-2 text-center rounded-md">
                                    {{ $message }}
                                </div>
