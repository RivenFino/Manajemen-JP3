...
<div class="content-wrapper h-[calc(100vh-4rem)] overflow-y-auto bg-gray-200">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-12">
                    <h3 class="m-0 content-title text-xl text-red-950 font-semibold">Data Riwayat Ganjil</h3>
                </div>
            </div>
        </div>
    </div>
                            ...
                            <tbody>
                                @foreach ($riwayat as $d)
                                    <tr>
                                        ...
                                        <td>{{ $d->total_jp }}</td>
                                        <td>
                                            <form action="{{route('riwayat.hapus', $d->id)}}">
                                                <a href="{{route('riwayat.ubah', $d->id)}}">
                                                    Edit
                                                </a>
                                                <button>
                                                    Hapus
